 ...
 * (`packages/web-buddy`) while exposing this package's Playwright browser tools
 * as an MCP server.
 */
...
const WEB_BUDDY_ROOT = join(REPO_ROOT, 'packages', 'web-buddy')
...
function buildEnv(flags) {
  ...
  const packageEnv = loadDotEnv(join(WEB_BUDDY_ROOT, '.env'))
